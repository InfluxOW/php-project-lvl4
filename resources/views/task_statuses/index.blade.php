                        ...
                        <td class="col-md-2">
                            <div class="container">
                                <div class="row">
                                    ...
                                    @endcan
                                    @can('delete', $status)
                                        <a href="{{ route('task_statuses.destroy', $status) }}" data-confirm="Are you sure? This action will also delete all tasks associated with this status." data-method="delete" rel="nofollow" class="btn btn-primary col-6">{{ __('Delete') }}</a>
                                    @endcan
                                </div>
                            </div>
                        </td>
